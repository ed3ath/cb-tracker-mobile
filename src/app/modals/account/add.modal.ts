...
export class AddModalComponent implements OnInit {
  ...
  constructor(private _modalCtrl: ModalController, private _storage: Storage, private _toaster: ToastController) {}
  ...
  async addAccount() {
    if (this._name && this._address) {
      ...
      this.displayToaster(`${this._address} has been added.`);
      this._modalCtrl.dismiss();
    }
  }
